# Transfer manifest â€” See installed models and their metadata

## Schedule A â€” Included (typical)

1. Git repository `theworker02/veyra-scientific` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for See installed models and their metadata
